...
DHTPIN = 18 
url = "http://openapi.seoul.go.kr:8088/7a4f4452736b6d7333384e747a466f/xml/RealtimeCityAir/1/5/도심권/" #도심권의 데이터를 받아오는 api 주소
area = ["중구",];
...
try:
  while True:
    ...
    res = requests.get(url+area[0]) # res 에 api 에서 받아온 xml 을 저장한다.
